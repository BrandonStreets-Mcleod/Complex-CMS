...
if (isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true) {
    header("location: stats.php"); //if the session is set to logged in and logged in is true the redirects to welcome.php
    exit;
}
                ...
                if ($stmt->num_rows == 1) {
                    ...
                    if ($stmt->fetch()) {
                        if (password_verify($password, $hashed_password)) {
                            ...
                            header("location: stats.php"); //sends user to welcome.php once session has be created.
                        }
                        else {
